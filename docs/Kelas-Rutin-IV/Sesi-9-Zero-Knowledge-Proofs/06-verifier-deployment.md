...
Dokumentasi lengkap untuk deploy ZK Age Verification smart contract menggunakan Foundry pada Lisk Sepolia Testnet.
...
7. [Deployment ke Lisk Sepolia Testnet](#7-deployment-ke-lisk-sepolia-testnet)
...
```bash
# Create project dengan template Monad (XD)
...
contract DeployAgeVerifier is Script {
    ...
    function run() public returns (AgeVerifier, Groth16Verifier, address, address) {
        console.log("Starting Age Verification System deployment to Lisk Sepolia Testnet...\n");
        ...
        console.log(string.concat("https://sepolia-blockscout.lisk.com/address/", _addressToString(verifierAddress)));
        console.log("AgeVerifier explorer:");
        console.log(string.concat("https://sepolia-blockscout.lisk.com/address/", _addressToString(ageVerifierAddress)));
        ...
        console.log("REACT_APP_LISK_SEPOLIA_TESTNET_RPC=https://rpc.sepolia-api.lisk.com/");
        ...
        console.log("cast call", ageVerifierAddress, "\"isVerifiedAdult(address)(bool)\" <ADDRESS> --rpc-url https://rpc.sepolia-api.lisk.com/");
        console.log("\nCheck commitment status:");
        console.log("cast call", ageVerifierAddress, "\"isCommitmentUsed(uint256)(bool)\" <COMMITMENT> --rpc-url https://rpc.sepolia-api.lisk.com/");
    ...
    function _saveDeploymentInfo(address ageVerifierAddress, address verifierAddress, address deployer) internal {
        string memory deploymentInfo = string.concat(
            ...
            '      "explorer": "https://sepolia-blockscout.lisk.com/address/', _addressToString(ageVerifierAddress), '"\n',
            '    },\n',
            '    "Groth16Verifier": {\n',
            '      "address": "', _addressToString(verifierAddress), '",\n',
            '      "explorer": "https://sepolia-blockscout.lisk.com/address/', _addressToString(verifierAddress), '"\n',
            '    }\n',
            '  },\n',
            ...
            '    "REACT_APP_LISK_SEPOLIA_TESTNET_RPC": "https://rpc.sepolia-api.lisk.com/",\n',
        ...
        try vm.writeFile("deployments/age-verifier-lisk-sepolia-testnet.json", deploymentInfo) {
            console.log("\nDeployment info saved to: deployments/age-verifier-lisk-sepolia-testnet.json");
        } catch {
...
forge script script/DeployAgeVerifier.s.sol --rpc-url https://rpc.sepolia-api.lisk.com/

# Test dengan fork
forge script script/DeployAgeVerifier.s.sol --fork-url https://rpc.sepolia-api.lisk.com/
```
...
```bash
# Check balance
cast balance $(cast wallet address --account zk-deployer) --rpc-url https://rpc.sepolia-api.lisk.com/

# Convert to readable format
cast balance $(cast wallet address --account zk-deployer) --rpc-url https://rpc.sepolia-api.lisk.com/ | cast to-unit ether
```

---

## 7. Deployment ke Lisk Sepolia Testnet
...
```bash
# Check current nonce
cast nonce $(cast wallet address --account zk-deployer) --rpc-url https://rpc.sepolia-api.lisk.com/
...
```bash
# Test RPC connection
cast client --rpc-url https://rpc.sepolia-api.lisk.com/
