...
<div style={{background:'#E8F5E9',borderRadius:'8px',padding:'16px',margin:'0 0 18px'}}>
  <p style={{fontSize:'15px',fontWeight:'600',margin:'0 0 12px'}}>🔧 Setup Ethereum Sepolia Testnet (WAJIB!):</p>
  ...
  <div style={{background:'#fff',borderRadius:'6px',padding:'12px',margin:'0 0 10px'}}>
    <p style={{fontSize:'14px',fontWeight:'600',margin:'0 0 6px'}}>Step 1: Tambah Sepolia ke MetaMask</p>
    <p style={{fontSize:'13px',margin:'0 0 8px',color:'#666'}}>Sepolia biasanya sudah tersedia di MetaMask. Jika belum, tambahkan melalui Chainlist:</p>
    <a href="https://chainlist.org/?chain=11155111&search=sepolia&testnets=true" target="_blank"
       style={{display:'inline-block',padding:'8px 16px',fontSize:'13px',fontWeight:'600',color:'#fff',background:'#3C3C3D',
  ...
  <div style={{background:'#fff',borderRadius:'6px',padding:'12px',margin:'0 0 10px'}}>
    <p style={{fontSize:'14px',fontWeight:'600',margin:'0 0 6px'}}>Step 2: Claim Sepolia ETH dari Google Cloud Faucet</p>
    <p style={{fontSize:'13px',margin:'0 0 8px',color:'#666'}}>Claim Sepolia ETH gratis untuk biaya gas:</p>
  ...
  <div style={{background:'#fff',borderRadius:'6px',padding:'12px',margin:'0'}}>
    <p style={{fontSize:'14px',fontWeight:'600',margin:'0 0 6px'}}>Step 3: Faucet Alternatif (Alchemy)</p>
    <p style={{fontSize:'13px',margin:'0 0 8px',color:'#666'}}>Jika Google Faucet tidak tersedia, gunakan Alchemy Faucet:</p>
...
3. Pastikan MetaMask terhubung ke **Sepolia Test Network**
...
2. **Test Block Properties:**
   ...
   - Klik `getChainId` → Harus 11155111 (Sepolia)
3. **Test Msg Properties:**
   - Klik `getMsgSender` → Lihat alamat wallet Anda
   - Masukkan VALUE 0.001 ETH → Klik `getMsgValue` → Lihat jumlah wei
...
<div style={{background:'linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%)',borderRadius:'12px',padding:'24px',margin:'0 0 24px',color:'#fff'}}>
  <h3 style={{margin:'0 0 12px',fontSize:'20px',fontWeight:'700'}}>CrowdFund: Decentralized Crowdfunding Platform</h3>
  ...
  <div style={{display:'flex',gap:'12px',flexWrap:'wrap'}}>
    <span style={{background:'rgba(255,255,255,0.2)',padding:'6px 12px',borderRadius:'20px',fontSize:'12px'}}>💰 Crowdfunding</span>
    <span style={{background:'rgba(255,255,255,0.2)',padding:'6px 12px',borderRadius:'20px',fontSize:'12px'}}>🗳️ Governance</span>
    <span style={{background:'rgba(255,255,255,0.2)',padding:'6px 12px',borderRadius:'20px',fontSize:'12px'}}>⏰ Time-Based</span>
    <span style={{background:'rgba(255,255,255,0.2)',padding:'6px 12px',borderRadius:'20px',fontSize:'12px'}}>⛓️ Ethereum Sepolia</span>
  </div>
</div>
...
**Latar Belakang:**
Platform crowdfunding tradisional seperti Kickstarter memiliki beberapa masalah: biaya perantara tinggi, kurang transparan, dan dana bisa disalahgunakan. Dengan blockchain, kita bisa membuat platform crowdfunding yang:
...
1. Creator membuat campaign crowdfunding dengan target dan deadline
2. Siapa saja bisa berkontribusi ETH ke campaign
3. Jika target tercapai sebelum deadline, creator bisa claim dana
4. Jika target TIDAK tercapai, kontributor bisa refund
5. Tracking kontribusi dan status campaign secara real-time
...
1. Buat repository baru di GitHub dengan nama: `eth-crowdfund-[nama-anda]`
2. Struktur folder:
```
...
1. **Mulai dari yang simple** - Implementasi `createCampaign` dan `getCampaignDetails` dulu
2. **Test setiap fungsi** - Jangan lanjut sebelum fungsi sebelumnya bekerja
3. **Gunakan Remix** - Deploy di Remix VM dulu sebelum ke Sepolia
4. **Perhatikan reentrancy** - Di fungsi `refund`, set kontribusi ke 0 SEBELUM transfer
5. **Baca error message** - Error Solidity biasanya informatif
6. **Cek gas** - Pastikan ada cukup Sepolia ETH untuk deploy dan testing
