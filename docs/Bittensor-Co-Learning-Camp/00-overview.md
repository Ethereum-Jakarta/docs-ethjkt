...
description: Roadmap lengkap Bittensor Co-Learning Camp 9 — dari nol (Web3 & AI) sampai jadi miner aktif di SN41 & SN13.
---
...
```mermaid
flowchart LR
    A[Phase 0<br/>Prerequisites<br/>Nol → Paham] --> B[Phase 1<br/>Fundamentals<br/>Teori Bittensor]
    B --> C[Phase 2<br/>Building<br/>Hands-on Mining]
    C --> D[Phase 3<br/>Resources<br/>Lanjut Sendiri]
